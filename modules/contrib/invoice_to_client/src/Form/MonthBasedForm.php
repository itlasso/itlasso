...
/**
 * Class for month based invoice form.
 *
 * {@inheritdoc}
 */
class MonthBasedForm extends FormBase {
   ...
   * {@inheritdoc}
   *
   * Factory method to create an instance of the MonthBasedForm class.
   *
   ...
   *
   * @return static
   *   A new instance of the MonthBasedForm class.
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['structure'] = [
      '#type' => 'table',
      '#title' => 'invoice Table',
      '#header' => ['Employee Name', 'Employee Id', 'Price/month', 'Working Days', 'Days(worked)', 'Amount'],
      '#attributes' => [
        'class' => ['table'],
      ],
    ...
    if ($result == NULL) {
      ...
      foreach ($result as $row) {
        ...
        $form['structure'][$id]['working_days'] = [
          '#type' => 'textfield',
          '#title' => t('Working day'),
          '#size' => 5,
          '#default_value' => '',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    try {
      ...
      foreach ($values as $index) {
        ...
        $field['Working_days'] = $index['working_days'];
        $field['Days_or_hours_worked'] = $index['days'];
