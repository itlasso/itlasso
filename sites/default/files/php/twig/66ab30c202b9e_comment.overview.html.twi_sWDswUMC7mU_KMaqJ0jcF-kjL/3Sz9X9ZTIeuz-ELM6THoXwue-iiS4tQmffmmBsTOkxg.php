...
class __TwigTemplate_d691754be35a02c550ba8099db50add8 extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}See the related topics listed below for specific tasks.{% endtrans %}</p>", "@help_topics/comment.overview.html.twig", "/var/www/html/core/modules/comment/help_topics/comment.overview.html.twig");
    }
