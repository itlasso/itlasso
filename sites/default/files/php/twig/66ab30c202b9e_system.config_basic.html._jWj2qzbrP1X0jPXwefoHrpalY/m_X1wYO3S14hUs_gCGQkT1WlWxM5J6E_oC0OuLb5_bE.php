...
class __TwigTemplate_4fc747e38c649af21b6cc285d8a3bbee extends Template
{
    private $source;
    private $macros = [];
...
<p>{% trans %}<a href=\"https://www.php.net/manual/datetime.format.php#refsect1-datetime.format-parameters\">PHP date format codes reference</a>{% endtrans %}</p>", "@help_topics/system.config_basic.html.twig", "/var/www/html/core/modules/system/help_topics/system.config_basic.html.twig");
    }
