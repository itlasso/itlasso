...
class __TwigTemplate_2670c864392c0abf46c2a634db97ccfe extends Template
{
    private $source;
    private $macros = [];
...
<ol>
  ...
  <li>{% trans %}Click <em>Save configuration</em>. You should see a message indicating that the settings were saved.{% endtrans %}</li>
</ol>", "@help_topics/system.config_error.html.twig", "/var/www/html/core/modules/system/help_topics/system.config_error.html.twig");
    }
